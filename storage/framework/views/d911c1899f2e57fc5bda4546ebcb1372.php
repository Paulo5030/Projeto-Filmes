    ...
    <div class="col-m-12">
        <div class="row" id="auth-row">
            ...
            <div class="col-md-4" id="register-container">
                <h2>Criar Conta</h2>
                <form action="<?php echo e(route('authcreate')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app.templates.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/app/authUser.blade.php ENDPATH**/ ?>