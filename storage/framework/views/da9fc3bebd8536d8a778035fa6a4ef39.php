    ...
    <div class="row">
        ...
        <div class="offset-md-1 col-md-10" id="reviews-container">
            ...
            <div class="col-md-12" id="review-form-container">
                ...
                <form action="<?php echo e(route('addMovie')); ?>" id="review-form" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('app.templates.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/app/movie.blade.php ENDPATH**/ ?>